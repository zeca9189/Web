$(document).ready(function(){
    ...
    $('#save').click(function(){
		...
		var fX =  $("#loadimage").css("left");
		var fY =  $("#loadimage").css("top");
		var imagex = $("#loadimage").css("width");
		var imagey = $("#loadimage").css("height");

    	$.ajax({
    	    url: './merge.php',
    	    data:{ fname: fName, fx: "800" ,fy:"600" ,imagex:"100",imagey:"100"},
    	    type: 'POST',
    	    success: function(returndata){
